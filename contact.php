...
//Success message
define('__SUCCESS_MESSAGE__', "Your message has been sent. I'll reply as soon as possible. Thanks!");

//Error message
define('__ERROR_MESSAGE__', "Your message has not been sent. Please try that again.");
